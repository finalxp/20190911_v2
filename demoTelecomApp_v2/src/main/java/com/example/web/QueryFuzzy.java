...
public class QueryFuzzy {
	...
	@RequestMapping(value = "queryFuzzyDep", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
	@ResponseBody
	public List<User> queryFuzzyDep(HttpServletRequest request) throws Exception{
