...
public class KafukaProducer {
    ...
    public static  Properties assembleProperties()
    {
        ...
        props.put(ProducerConfig.ACKS_CONFIG, "all");//瀵瑰簲partition鐨刲eader鍐欏埌鏈湴鍚庡嵆杩斿洖鎴愬姛銆傛瀬绔儏鍐典笅锛屽彲鑳藉鑷村け璐 br/>        props.put(ProducerConfig.BUFFER_MEMORY_CONFIG, 33554432);
