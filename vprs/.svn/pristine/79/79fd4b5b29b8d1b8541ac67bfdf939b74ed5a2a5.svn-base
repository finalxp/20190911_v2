...
public abstract class AbstractService {
    ...
    public static Result invoke2(String param,Map<String,Object> param2,Object request){
    	ProxyContext context = Invoker.initProxyContext(param, Version.DefaultVersion, null, param2, request, false);
    	return Invoker.invoke(context);	
    }
}
