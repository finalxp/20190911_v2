...
public class ChannelThreshold implements Serializable{
	...
	private BigDecimal thresholdBak;
	private BigDecimal thresholdDefined;
	...
	public BigDecimal getThresholdBak() {
		return thresholdBak;
	}
	public void setThresholdBak(BigDecimal thresholdBak) {
		this.thresholdBak = thresholdBak;
	}
	public BigDecimal getThresholdDefined() {
		return thresholdDefined;
	}
	public void setThresholdDefined(BigDecimal thresholdDefined) {
		this.thresholdDefined = thresholdDefined;
	}
	@Override
	public String toString() {
		return "阈值信息："+"渠道："+this.getChannel()+"---阈值1："+this.getThreshold()+"----阈值2："+this.getThresholdBak();
	}
