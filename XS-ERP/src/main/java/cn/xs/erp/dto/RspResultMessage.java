...
public enum RspResultMessage {
	...
	EditDepartmentSuccess("0","修改部门成功！"),
	EditDepartmentFailed("001102","修改部门失败！"), 
	
	DeleteDepartmentItemSuccess("0","删除部门成功！"),
	DeleteDepartmentItemFailed("001103","删除部门失败！"),

	
	ErrorInputEmployeePassword("100001","员工原始密码输入错误！"), 
	
	AddSystemParameterSuccess("0","添加系统参数成功！"),
	AddSystemParameterFailed("110001","添加系统参数失败！"), 
	
	EditSystemParameterSuccess("0","修改系统参数成功！"),
	EditSystemParameterFailed("120001","修改系统参数失败！"), 
	
	DeleteSystemParameterSuccess("0","删除系统参数成功！"),
	DeleteSystemParameterFailed("130001","删除系统参数失败！"), 
	
	
	DeleteDepartmentSuccess("0","删除部门成功！"),
	DeleteDepartmentFailed("150001","删除部门失败！"),
