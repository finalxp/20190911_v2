...
public class DoorPermissionController extends BaseController{
	...
	@RequestMapping("/door_manager/add")
	public String add(Model model){
		EmployeeItem eItem =new EmployeeItem();
		List<DoorItem> list = new ArrayList<DoorItem>();
		eItem.setDoorPermission(list);
		model.addAttribute("empDoorPermission", eItem);
	...
	@ResponseBody
	public RspResultDto updateDoorPermission(EmployeeItem eItem,@RequestParam int[] doorID){
